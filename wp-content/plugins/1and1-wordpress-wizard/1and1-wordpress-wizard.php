...
class One_And_One_Wizard {
	...
	public function add_styles() {
		...
		wp_enqueue_style( '1and1-setup-wizard', self::get_css_url() . '1and1-setup-wizard' . $suffix . '.css', array(), self::VERSION );
		wp_enqueue_style( '1and1-install-progress', self::get_css_url() . '1and1-install-progress' . $suffix . '.css', array(), self::VERSION );
	}
	...
	public static function get_css_url() {
		return plugins_url( 'css', __FILE__ ) . '/';
	}
...
$oao_wizard = new One_And_One_Wizard();
