...
class One_And_One_Theme_Selection_Step {
	...
	static public function get_theme_selection( $site_type ) {
		...
		$current_theme_info = self::get_current_theme_info();
	...
	static private function get_current_theme_info() {
		$current_theme = wp_get_theme();
		$current_theme_slug = $current_theme->get_stylesheet();

		return themes_api( 'theme_information', array( 'slug' => $current_theme_slug, 'fields' => array( 'sections' => true, 'tags' => true ) ) );
	}
