...
function espied_continue_reading_link() {
	return '&hellip; <a href="'. esc_url( get_permalink() ) . '">' . sprintf( __( 'Continue reading <span class="screen-reader-text">%1s</span>', 'espied' ), esc_attr( strip_tags( get_the_title() ) ) ) . '</a>';
}
